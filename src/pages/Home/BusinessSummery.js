    ...
    return (
        <div>
            <div className='my-10 text-center'>
                <h3 className='text-3xl border-b-4 rounded-lg inline-block border-accent font-semibold'>Business Summery</h3>
            </div>
