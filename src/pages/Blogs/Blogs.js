...
const Blogs = () => {
  return (
    <div className="accordion mx-20 my-10" id="accordionExample">
      <div className="accordion-item bg-accent border border-secondary">
        <h2 className="accordion-header mb-0" id="headingOne">
          <button
            className=" accordion-button relative flex items-center w-full py-4 px-5
        text-base text-primary text-left bg-accent border-0 rounded-none transition focus:outline-none
      "
            type="button"
      ...
      <div className="accordion-item bg-accent border border-secondary">
        <h2 className="accordion-header mb-0" id="headingTwo">
          <button
            className="accordion-button collapsed relative flex items-center w-full py-4 px-5 text-base text-primary text-left bg-accent border-0 rounded-none transition focus:outline-none "
            type="button"
            data-bs-toggle="collapse"
        ...
        >
          <div className="accordion-body py-4 px-10 md:px-20">
            <p>
              ...
              your React apps:
              <ul>
                <li className="list-disc ml-10">Local state</li>
                <li className="list-disc ml-10">Global state</li>
                <li className="list-disc ml-10">Server state</li>
                <li className="list-disc ml-10">Url state</li>
              </ul>
            </p>
          </div>
        </div>
