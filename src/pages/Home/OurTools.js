                        ...
                        <div className="card w-full sm:w-96  bg-gradient-to-r from-sky-600 to-indigo-500 text-gray-200  shadow-xl shadow-secondary">
                            ...
                            <div className="card-body items-start text-Justify">
                                ...
                                <div className="card-actions w-full">
                                    <button className="btn hover:border-0 hover:shadow-xl bg-slate-800 hover:bg-gradient-to-r from-indigo-900 via-indigo-400 to-indigo-900 text-slate-100 hover:text-slate-900 my-3 w-full hover:font-bold">Order Now</button>
                                </div>
                            </div>
                        </div>
                    </>)
